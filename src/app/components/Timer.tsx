...
const MODE_SETTINGS = {
  focus: { label: "Focus", duration: 25, music: "/audio/focus-music.mp3" },
  shortBreak: {
    label: "Short Break",
    duration: 5,
    music: "/audio/short-break.mp3",
  },
  longBreak: {
    label: "Long Break",
    duration: 15,
    music: "/audio/long-break.mp3",
  },
};
              ...
              className={`px-6 py-3 rounded-full font-semibold transition-transform duration-300 ease-in-out shadow-md
                ${
                  mode === key
                    ...
                    : "bg-amber-100 text-amber-700 hover:bg-amber-300 hover:scale-105"
                }
              `}
