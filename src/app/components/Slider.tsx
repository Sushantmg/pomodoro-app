...
const Slider: React.FC<SliderProps> = ({
  ...
  sx={{
  color: "#ffd17d", // Thumb + track color
  height: 8,
  ...
  "& .MuiSlider-rail": {
    backgroundColor: "#e0e0e0", // Lighter rail for white bg
  },

  "& .MuiSlider-mark": {
    backgroundColor: "#9e9e9e", // Darker dot for visibility
    height: 2,
    width: 2,
    marginTop: -2,
  },
  ...
  "& .MuiSlider-markLabel": {
    color: "#b0b0a2", // Clean gray label text
    fontSize: "0.75rem",
